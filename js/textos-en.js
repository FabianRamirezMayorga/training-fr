...
(function (g) {
  ...
  g.TEXTOS_EN = {
    ...
    /* ---------- los primeros pasos de una cuenta nueva ---------- */
    'Paso {n} de 2': 'Step {n} of 2',
    'Cuéntame de ti': 'Tell me about you',
    'El sexo, la edad, la altura y el peso son los cuatro con los que se calcula todo lo demás: tus calorías, tus macros y lo que te propongo entrenar. Lo demás de esta página es opcional y se puede rellenar otro día.': 'Sex, age, height and weight are the four everything else is worked out from: your calories, your macros and what I suggest you train. The rest of this page is optional and can wait for another day.',
    'Todavía falta {que}. Puedes seguir y volver luego, pero hasta que estén no puedo calcular tus calorías.': 'Still missing {que}. You can carry on and come back later, but until they are in I cannot work out your calories.',
    'Puesto': 'Set up',
    'Dos conexiones, si te apetece': 'Two connections, if you fancy',
    'Las dos son gratis y opcionales, y las dos van con una clave tuya que la app no ve ni guarda en ningún servidor. Puedes saltártelas y ponerlas otro día desde Perfil.': 'Both are free and optional, and both run on a key of your own that the app never sees or stores on any server. You can skip them and set them up another day from Profile.',
    'Lee tus entrenamientos y te dice qué ajustar, te monta el programa y el menú de comidas, y calcula un plato con una foto. Con la capa gratuita de Google sobra y no pide tarjeta.': 'It reads your workouts and tells you what to adjust, builds your programme and your meal plan, and works out a plate from a photo. Google’s free tier is plenty and asks for no card.',
    'Música mientras entrenas': 'Music while you train',
    'Conecta tu Spotify y la app te pone la lista al empezar la rutina y la para al terminar. Hace falta cuenta Premium y un Client ID, que se saca gratis en la web de desarrolladores de Spotify.': 'Connect your Spotify and the app starts your playlist when the routine begins and stops it at the end. It needs a Premium account and a Client ID, which is free from Spotify’s developer site.',
    'Lo que va sin conectar nada': 'What works with nothing connected',
    'El catálogo entero con su técnica, tus rutinas, el generador de programas, el cronómetro, el historial, las estadísticas y la constancia. Todo eso no necesita ni clave ni internet.': 'The whole catalogue with its technique guides, your routines, the programme generator, the timer, your history, the stats and the streak. None of that needs a key or internet.',
    'Listo, llévame a la app': 'Done, take me to the app',
    'Todo tuyo. Las dos conexiones están en Perfil cuando las quieras.': 'All yours. Both connections are in Profile whenever you want them.',
    'Te falta terminar de configurar': 'You still have setup to finish',
    'Sin tus datos no puedo calcular calorías ni ajustarte las rutinas.': 'Without your details I cannot work out calories or tailor your routines.',
    'Te quedaba mirar el entrenador con IA y la música.': 'You still had the AI coach and the music to look at.',
    'Cuenta lista. Vamos con tus datos.': 'Account ready. Now for your details.',
    ...
    'Minutos': 'Minutes',
    'min': 'min',
    'Mirando qué es…': 'Working out what it is…',
    'Lo que acabas de hacer': 'What you just did',
    'Guardar y analizarlo con la IA': 'Save and have the AI look at it',
    ...
    'No entrenaste': 'You did not train',
    '{n} de {meta} g': '{n} of {meta} g',
    '{n} g': '{n} g',
    '{n} de {meta} l': '{n} of {meta} l',
    '{n} l': '{n} l',
    '{n} de {meta} kcal': '{n} of {meta} kcal',
