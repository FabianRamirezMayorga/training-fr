    ...
    { id: 'c-suplementos', titulo: 'Apuntar lo que tomas',
      ...
      pasos: [
        ...
        { t: 'Y si vas *A mano*, pon cada hora en la rueda.',
          d: 'Se abre un panel con una rueda de hora, como la del reloj del móvil. Gírala hasta la hora que quieras, toca *Añadir esta hora* y se queda abajo en «Tus horas». Repite hasta tenerlas todas —las que sobren se quitan tocando la × de cada una— y termina con *Listo*. Se crea una alerta por cada hora.' },
