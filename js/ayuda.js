  ...
  const PREGUNTAS = [
    ...
    { id: 'p-supvarias', q: '¿Y si tomo algo varias veces al día?',
      a: ['En «cada cuánto» elige *Varias al día* y te pregunta ahí mismo cómo lo repartes.',
        'Por reloj —cada 4, 6, 8 o 12 horas— arrancando a la hora que digas y cortando en la cena. Con tus comidas: antes, con o después de cada una, y entonces se mueven solas si cambias una hora de comer. O a mano, poniendo tú cada hora.',
