...
(function (g) {
    ...
    { id: 'c-foto', titulo: 'Apuntar una comida con foto',
      ...
      pasos: [
        ...
        { t: 'Toca *Foto de lo que comes*.',
          d: 'Puedes hacerla en el momento o elegir una de la galería. Lo segundo es para cuando comes sin cobertura: fotografía el plato con la cámara del móvil y súbelo luego, que la IA necesita internet para leerla.' },
        { t: 'Deja que la lea.',
          d: 'Calcula lo que llevaba: calorías, proteína y el resto. Esto sí usa la IA, así que necesita conexión y tu clave puesta. Si la subes sin cobertura te lo dice y no se pierde nada: la foto sigue en tu galería.' },
        { t: 'La hora es la de la foto, no la de ahora.',
          d: 'Una foto de la galería se apunta a la hora en que la hiciste, así que el plato de las dos se cruza con la comida y no con la cena. Solo si es del mismo día: una de ayer se apunta como de hoy.' },
        { t: 'Mira el cruce.',
  ...
  const PREGUNTAS = [
    ...
    { id: 'p-fotosinred', q: '¿Puedo apuntar una comida con foto sin internet?',
      a: ['Apuntarla no, porque quien lee la foto es la IA y la IA vive fuera del móvil. La app te lo dice en cuanto lo intentas, en vez de dejarte con una rueda girando.',
