...
(function (g) {
  ...
  const AYUDA = {
    ...
    'En la portada, «Tu semana» son los siete días de atrás con tres puntos cada uno: si entrenaste, si llegaste a la proteína y si bebiste el agua. Mira hacia atrás y no hacia delante a propósito —un lunes, la semana que viene está vacía y no cuenta nada—. Es la misma tira que en *Ver mi día*, donde además está explicada.':
      'On the home screen, “Your week” is the last seven days with three dots each: whether you trained, whether you hit your protein and whether you drank your water. It looks back and not forward on purpose —on a Monday, the week ahead is empty and says nothing. It is the same strip as in *See my day*, where it is also explained.',
