...
const FILES = [
  ...
  './js/revisar.js', './js/admin.js', './js/musculos.js', './js/dia.js', './js/importar.js', './js/compartir.js', './js/progresion.js', './js/workout.js', './js/app.js',
