...
const FILES = [
  ...
  './js/textos-en.js', './js/textos-en-ayuda.js', './js/idioma.js', './js/paises.js', './js/perfil.js', './js/objetivos.js', './js/suplementos.js', './js/alertas.js', './js/saludo.js', './js/ia.js',
