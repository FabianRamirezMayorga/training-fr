...
const FILES = [
  './', './index.html',
  './css/styles.css',
  './js/i18n.js', './js/tecnica.js', './js/store.js', './js/ui.js', './js/instalar.js',
  ...
  './js/textos-en.js', './js/textos-en-ayuda.js', './js/textos-en-tecnica.js', './js/idioma.js', './js/paises.js', './js/perfil.js', './js/objetivos.js', './js/suplementos.js', './js/alertas.js', './js/saludo.js', './js/ia.js',
  './js/guia.js', './js/pendientes.js', './js/spotify.js', './js/marcar.js', './js/vistas.js', './js/vistas2.js', './js/vistas3.js',
  ...
  './icons/icon-180.png', './icons/icon-maskable-192.png', './icons/icon-maskable-512.png'
];
