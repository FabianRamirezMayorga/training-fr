...
const FILES = [
  ...
  './js/yoga.js', './js/figura.js', './js/calistenia.js', './js/zona.js', './data/catalogo-es.json', './js/data.js', './js/comidas.js', './js/menus.js',
  ...
  './js/revisar.js', './js/admin.js', './js/musculos.js', './js/dia.js', './js/importar.js', './js/compartir.js', './js/workout.js', './js/app.js',
